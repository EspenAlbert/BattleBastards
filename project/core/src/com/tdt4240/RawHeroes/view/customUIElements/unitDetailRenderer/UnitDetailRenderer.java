...
public class UnitDetailRenderer implements IRenderNoPos {
    ...
    private void updateDialog(IUnit unit) {
        ...
        textFieldHealth.setPosition(col3, createUnitDetailsScreenDialog.getHeight()*5/6);
        ...
        textFieldAttack.setPosition(col3, createUnitDetailsScreenDialog.getHeight()*4/6);
        ...
        textFieldArmor.setPosition(col3, createUnitDetailsScreenDialog.getHeight()*3/6);
