...
public class FinishScreenRenderer implements IRenderNoPos {
    ...
    public static String[] noOptionMessages = {"It is not your turn to do a move!", "You successfully did moves to game:", "You lost the game against","Congratulations you won!"};
